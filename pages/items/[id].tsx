      ...
      <div className="px-4 py-10">
        <div className="mb-8">
          ...
          <div className="flex cursor-pointer py-3 border-t border-b items-center space-x-3">
            ...
            <div>
              <p className="text-sm font-medium teext-gray-700">
                Stephen Joves
              </p>
          ...
          <div className="mt-5">
            ...
            <p className="my-6 text-gray-700">
              Smooth like butter Like a criminal undercover Gon’ pop like
              trouble Breakin’ into your heart like that Cool shade stunner Yeah
              I owe it all to my mother. Hot like summer Yeah I’m makin’ you
              sweat like that Break it down
            </p>
